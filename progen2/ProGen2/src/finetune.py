...
def main(args: argparse.Namespace):
    ...
    tokenizer: Tokenizer = Tokenizer.from_file("/root/autodl-tmp/PP_generate_v1/logs/progen2/tokenizer.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="/root/autodl-tmp/PP_generate_v1/logs/progen2",
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/root/autodl-tmp/PP_generate_v1/data/downloads/train_data_3_fams.txt',
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        default='/root/autodl-tmp/PP_generate_v1/data/downloads/test_data_3_fams.txt',
